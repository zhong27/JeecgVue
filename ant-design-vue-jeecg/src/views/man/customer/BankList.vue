<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button v-has="'people:button'" type="primary" icon="download" @click="handleExportXls('银行卡信息')">导出</a-button>
      <a-upload
        name="file"
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-popconfirm v-has="'people:button'" title="确定删除吗?" @confirm="() => handleDelete(record.id)">
            <a>删除</a>
          </a-popconfirm>
        </span>
    ...
    <bank-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></bank-modal>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    components: { BankModal,JSuperQuery },
    props:{
      mainId:{
        type:String,
        default:'',
