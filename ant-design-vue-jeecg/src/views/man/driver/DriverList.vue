<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button v-has="'people:button'" type="primary" icon="download" @click="handleExportXls('司机')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/man/driver/list",
          delete: "/man/driver/delete",
          deleteBatch: "/man/driver/deleteBatch",
          exportXlsUrl: "/man/driver/exportXls",
          importExcelUrl: "man/driver/importExcel",
