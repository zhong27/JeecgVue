          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="所在地区">
                <j-area-linkage type="cascader" v-model="queryParam.address" placeholder="请选择省市区"/>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<script>
  ...
  import ConsigneeModal from './modules/ConsigneeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/man/consignee/list",
          delete: "/man/consignee/delete",
          deleteBatch: "/man/consignee/deleteBatch",
          exportXlsUrl: "/man/consignee/exportXls",
          importExcelUrl: "man/consignee/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'pca',value:'address',text:'所在地区'})
        fieldList.push({type:'string',value:'addressDet',text:'详细地址',dictCode:''})
