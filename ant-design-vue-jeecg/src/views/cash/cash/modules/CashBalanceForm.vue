        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="资金账户" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['customerName', validatorRules.customerName]" :trigger-change="true" dictCode="man_customer where del_flag = 0,customer_name,id" placeholder="请选择资金账户" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="总金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['totalMoney']" placeholder="请输入总金额" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cash/cashBalance/add",
          edit: "/cash/cashBalance/edit",
          queryById: "/cash/cashBalance/queryById"
        }
      }
    },
    computed: {
