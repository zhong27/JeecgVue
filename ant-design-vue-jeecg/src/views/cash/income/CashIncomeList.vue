<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="来款银行">
              <j-dict-select-tag placeholder="请选择来款银行" v-model="queryParam.bank" dictCode="bank"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <cash-income-modal ref="modalForm" @ok="modalFormOk"></cash-income-modal>
  </a-card>
</template>
