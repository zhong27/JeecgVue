        ...
        <a-row>
          <a-col :span="12">
            <a-form-item label="客户" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['customerName', validatorRules.customerName]" :trigger-change="true" dictCode="man_customer where del_flag = 0,customer_name,id" placeholder="请选择客户" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="来款银行" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['bank', validatorRules.bank]" :trigger-change="true" dictCode="bank" placeholder="请选择来款银行" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="来款日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择来款日期" v-decorator="['incomeDate']" :trigger-change="true" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cash/cashIncome/add",
          edit: "/cash/cashIncome/edit",
          queryById: "/cash/cashIncome/queryById"
        }
      }
    },
    computed: {
