<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button v-has="'people:button'" type="primary" icon="download" @click="handleExportXls('业务员')">导出</a-button>
    ...
    <business-modal ref="modalForm" @ok="modalFormOk"></business-modal>
  </a-card>
</template>
...
<script>
  ...
  import BusinessModal from './modules/BusinessModal'
