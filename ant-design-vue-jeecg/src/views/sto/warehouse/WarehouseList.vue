<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="仓库名称">
              <j-dict-select-tag placeholder="请输入仓库名称" dictCode="sto_warehouse,house_name,house_name"
                                 v-model="queryParam.houseName"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="仓库地址">
              <j-area-linkage placeholder="请输入仓库地址" v-model="queryParam.address"></j-area-linkage>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button v-has="'people:button'" type="primary" icon="download" @click="handleExportXls('仓库管理')">导出</a-button>
