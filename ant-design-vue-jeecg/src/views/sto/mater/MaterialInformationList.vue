<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button v-has="'people:button'" type="primary" icon="download" @click="handleExportXls('材料规格信息')">导出</a-button>
    ...
    <material-information-modal ref="modalForm" @ok="modalFormOk"></material-information-modal>
  </a-card>
</template>
...
<script>
  ...
  import MaterialInformationModal from './modules/MaterialInformationModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/sto/materialInformation/list",
          delete: "/sto/materialInformation/delete",
          deleteBatch: "/sto/materialInformation/deleteBatch",
          exportXlsUrl: "/sto/materialInformation/exportXls",
          importExcelUrl: "sto/materialInformation/importExcel",
