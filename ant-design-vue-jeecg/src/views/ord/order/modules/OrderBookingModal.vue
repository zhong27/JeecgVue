        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="司机" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag placeholder="请选择司机" v-decorator="['driver', validatorRules.driver]" dictCode="man_driver,name,id" :trigger-change="true"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="收货人" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag placeholder="请选收货人" v-decorator="['consignee', validatorRules.consignee]" dictCode="man_consignee,name,id" :trigger-change="true"></j-dict-select-tag>
            </a-form-item>
          </a-col>
<!--
          <a-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createTime','customer','orderNo','orderTotal','driver','consignee','payStatus','business'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createTime','customer','orderNo','orderTotal','driver','consignee','payStatus','business'))
      },
