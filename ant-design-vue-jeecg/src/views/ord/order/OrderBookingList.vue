<template>
  <a-card :bordered="false">
    ...
    <orderBooking-modal ref="modalForm" @ok="modalFormOk"></orderBooking-modal>
  </a-card>
</template>
...
<script>
  ...
  import OrderBookingModal from './modules/OrderBookingModal'
  ...
  export default {
    ...
    methods: {
      initDictConfig(){
        ...
        initDictOptions('pay_status').then((res) => {
          if (res.success) {
