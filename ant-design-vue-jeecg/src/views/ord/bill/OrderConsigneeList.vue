<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <orderConsignee-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></orderConsignee-modal>
  </a-card>
</template>
...
<script>
  ...
  import OrderConsigneeModal from './modules/OrderConsigneeModal'
  import JSuperQuery from '@/components/jeecg/JSuperQuery.vue'


  export default {
    name: "OrderConsigneeList",
    mixins:[JeecgListMixin],
    components: { OrderConsigneeModal,JSuperQuery },
    props:{
      mainId:{
        type:String,
        default:'',
    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/ord/orderBill/deleteOrderConsignee",
          deleteBatch: "/ord/orderBill/deleteBatchOrderConsignee",
          exportXlsUrl: "/ord/orderBill/exportOrderConsignee",
          importUrl: "/ord/orderBill/importOrderConsignee",
        },
        dictOptions:{
        },
        superFieldList:[],
