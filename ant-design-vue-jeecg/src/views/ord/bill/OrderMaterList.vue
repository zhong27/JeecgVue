<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button v-has="'people:button'" type="primary" icon="download" @click="handleExportXls('提单材料明细')">导出</a-button>
      <a-upload
        name="file"
    ...
    <orderMater-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></orderMater-modal>
  </a-card>
</template>
...
<script>
  ...
  import OrderMaterModal from './modules/OrderMaterModal'
  ...
  export default {
    ...
    components: { OrderMaterModal,JSuperQuery },
    props:{
      mainId:{
        type:String,
        default:'',
    ...
    data () {
      return {
        ...
        url: {
          list: "/ord/orderBill/listOrderMaterByMainId",
          delete: "/ord/orderBill/deleteOrderMater",
          deleteBatch: "/ord/orderBill/deleteBatchOrderMater",
          exportXlsUrl: "/ord/orderBill/exportOrderMater",
          importUrl: "/ord/orderBill/importOrderMater",
        },
        dictOptions:{
        },
        superFieldList:[],
